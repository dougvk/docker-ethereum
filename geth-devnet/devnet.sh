...
geth --rpc --rpcaddr "0.0.0.0" --rpccorsdomain "*" --rpcapi "admin,db,eth,net,web3,personal" --dev --unlock 0 --password ~/.accountpassword --mine --minerthreads 1 --extradata "Kunstmaan"
